        ...
        <div class="lg:w-1/2 w-full mx-auto mt-8 overflow-auto">
            <table class="table-auto w-full text-left whitespace-nowrap">
                ...
                <tr>
                    ...
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200 rounded-tr rounded-br">
                        Actions
                    </th>
                </tr>
                </thead>
        ...
        <div class="lg:w-2/3 w-full mx-auto mt-8">
            ...
            <div class="flex flex-wrap -mx-2 mt-4">
                <div class="p-2 w-full">
                    <div class="relative">
                        <label for="card_element" class="leading-7 text-sm text-gray-600">Credit Card
                            Information</label>
